...
const  AccountNav = () => {
    ...
    function LinkClasses (type=null) {
        ...
        if (type  === subpage  ) {
        classes += ' background-btn text-white '
        } else{
            classes += ' bg-gray-200'
        }
        return classes
    ...
    return (        <nav className="w-full flex justify-center  gap-2 mt-10 mb-2"> 
...
My bookings</Link> 
    <Link className= {LinkClasses("cars")} to={'/account/cars'}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
<path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6.75h12M8.25 12h12m-12 5.25h12M3.75 6.75h.007v.008H3.75V6.75Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0ZM3.75 12h.007v.008H3.75V12Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm-.375 5.25h.007v.008H3.75v-.008Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
</svg>
My cars</Link> 
