        ...
        <>
          <div className="booking-widget bg-white  shadow px-4 rounded-2xl rounded-l-none mt-5 min-h-full  ">
            ...
            <div className="border rounded-2xl mt-4">
                ...
                <label>Pick up: </label>
                <input type="date" value={pickUp} onChange={ev => setPickUp(ev.target.value) } />
             
            </div>
            <div className="flex flex-col py-3 px-4 border-l ">
                <label>Drop off: </label>
                <input type="date" value={dropOff} onChange={ev => setDropOff(ev.target.value) } />
            </div>
                ...
                <div className="flex flex-col gap-2 py-3 pb-1 px-4 border-t">
                    ...
                    <input className="border border-gray-300 rounded-2xl h-10 px-3 " type="text" value={name} onChange={ev => setName(ev.target.value)} />
                </div>
                  <div className="flex flex-col gap-2 py-1 px-4 ">
                  <label>Your Email</label>
                  <input className="border border-gray-300 rounded-2xl h-10 px-3" type="email" value={email} onChange={ev => setEmail(ev.target.value)} />
              </div>
              <div className="flex flex-col gap-2 py-1 px-4 ">
                    <label>Your Phone Number</label>
                    <input className="border border-gray-300 rounded-2xl h-10 mb-5 px-3 " type="tel" value={phone} onChange={ev => setPhone(ev.target.value)} />
                </div>
              </div>
