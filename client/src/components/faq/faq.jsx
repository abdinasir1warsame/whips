...
const Faq = () => {
  return (
    <div className="mt-20 mb-20 min-h-screen flex flex-col justify-center items-center ">
      ...
      <div className="w-full max-w-5xl mx-auto p-5 lg:p-10  ">
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              {({ open }) => (
                <>
                  <Disclosure.Button className="flex justify-between items-center w-full px-6 lg:px-4 py-4 text-left lg:text-lg font-medium text-white rounded-2xl background focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
                  ...
                  >
                    <Disclosure.Panel className="pt-4 px-4 lg:px-8 pb-2 text-sm text-gray-600 font-bold">
                      {faq.answer}
                    </Disclosure.Panel>
                  </Transition>
                </>
