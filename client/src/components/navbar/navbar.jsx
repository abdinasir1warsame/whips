    ...
    <div>
        ...
        <nav className="mobile">
          ...
          <div className="m-menu">
            ...
            <ul>
              ...
              <li>
                <Link to={user ? '/cars' : '/login'} onClick={handleLinkClick}>
              ...
              <div className="mt-20 flex  justify-center gap-10 text-lg">
                {!user ? (
                  <>
                    <Link
                      to="/login"
                      onClick={handleLinkClick}
                      className=" border border-white px-4 py-2 shadow rounded-2xl cursor-pointer "
                    >
      ...
      <section className="main-nav py-4 flex flex-row justify-between px-10">
        ...
        <div className="flex gap-8 justify-center">
          <Link to={user ? '/cars' : '/login'} className="link">
            All Cars
          </Link>
          ...
          {!user ? (
            <>
              <Link
                to="/login"
                className="link background-btn2 ml-2 py-2 px-5 rounded-2xl"
              >
                LOGIN
              </Link>
            </>
            ...
            <div
              onClick={logout}
              className="link background-btn2 ml-2 py-1 px-5 rounded-2xl text-shadow"
            >
              LOG OUT
            </div>
          )}
